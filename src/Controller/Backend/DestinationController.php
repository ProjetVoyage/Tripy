...
class DestinationController extends AbstractController
{
    ...
    {
        return $this->render('backend/destination/index.html.twig', ['destinations' => $destinationRepository->findAll()]);
    }
    ...
    {
        return $this->render('backend/destination/show.html.twig', ['destination' => $destination]);
    }
    ...
    public function edit(Request $request, Destination $destination): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('destination_index', ['id' => $destination->getId()]);
        }
