...
class ExpenseController extends AbstractController
{
    ...
    public function new(TravelerRepository $travelerRepository, ExpenseRepository $expenseRepository, Request $request, Travel $travel): Response
    {
        ...
        $listTraveler = $expenseRepository->findTravelerByTravel($travel->getId(), $this->getUserConnected());
        
        $form = $this->createForm(ExpenseType::class, $expense, array('refundersList' => $listTraveler));
